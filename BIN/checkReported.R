...
## calculate p-value for number of variants going in the correct direction -- binomial test
print(binom.test(x=table(d.my$DIRECTION)[1], n=nrow(d.my), p=0.5))

## correct pvalues for multiple tests -- fdr
x <- d.my
